...
# Read in the file "mt_1_elections-poll-ca48-3.csv" (polling data for the 48th
# Congressional District in California) and store as a new dataset called
# "ca48_data"

ca48_data <- read_csv("elections-poll-ca48-3.csv")
